namespace WanaKanaNet.Tests.Helpers
{
    ...
    {
        public static readonly char[] JapanesePunctuation = new[] {
          '！',
          '？',
          '。',
          '：',
        ...
        public static readonly char[] EnglishPunctuation = new[]
        {
            '!',
            '?',
            '.',
        ...
        public static (string, string, string)[] RomajiToHiraganaKatakana = new (string, string, string)[]
        {
        ...
        public static readonly (string, string, string)[] HiraganaKatakanaToRomaji = new (string, string, string)[]
        {
            ("ヶ", "ヶ", "ヶ"),
            ("ヵ", "ヵ", "ヵ"),
            ("1", "1", "1"),
